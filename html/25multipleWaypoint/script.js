...
for (let i=0; i<numberOfGamepoints;i++){
  let x = waypoints[i].pos.dx;
  let y = waypoints[i].pos.dy;
  let gamepoint = new GameObject(new Vector2d(x,y),new Vector2d(0,0),new Vector2d(0,0));
  gamepoint.color = "blue";
  gamepoint.target = i+1;
